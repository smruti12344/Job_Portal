...
<%@include file="Components\navbar.jsp" %>
    <div class="container-fluid my-4">
        ...
        <form action="view_more.jsp"  method="get" >
            <div class="row d-flex justify-content-center">
                <div class="form-group col-md-6">
                    ...
                    <select type="text" name="loc" class="form-control" id="inputLocation" placeholder="Enter location">
                      <option value="lo">Choose one..</option>
                ...
                <div class="form-group col-md-6">
                    ...
                    <select id="inputCategory" name="cat" class="form-control">
                    <option value="ct">Choose one..</option>
        ...
        <div class="row mt-4">
        <%
         ArrayList<JobBean>activeJobs = new ViewJobDAO().activeJobs();
                    		for(JobBean activeJob : activeJobs)
                    		{%>
                   <div class="col-md-6">
